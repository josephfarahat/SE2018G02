...
<p class="truncate">If you want to delete all question click  </p> <br>
<button class="add-question-btn" type="submit">Clear</button> 
</form>  
        ...
        <form action ='questions.php' method='GET'>
            ...
            <div class="answer-container drag-answer col-1x">
                <div class="answer-options  ">
                    ...
                    <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers1" placeholder="Option 1">
                    </div>
                </div>
                <div class="answer-options  ">
                    <div class="control-indicator"></div>
                    <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers2" placeholder="Option 2">
                    </div>
                </div>
                <div class="answer-options  ">
                    <div class="control-indicator"></div>
                    <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers3" placeholder="Option 3">
                    </div>
                </div>
                <div class="answer-options  ">
                    <div class="control-indicator"></div>
                    <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers4" placeholder="Option 4">
                    </div>
                </div>
                 <div class="answer-options  ">
                    <div class="control-indicator"></div>
                    <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers5" placeholder="Option 5">
                    </div>
                </div>
                  <div class="answer-options  ">
                      <div class="control-indicator"></div>
                      <div class="form-group ">
                        <input type="text" class="form-control" required="" name="answers6" placeholder="Option 6">
                    </div>
                </div>
            </div>
